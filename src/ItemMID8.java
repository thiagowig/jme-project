...
public class ItemMID8 extends MIDlet implements CommandListener, ItemStateListener {
...
class ExemploCustomItem extends CustomItem {
	int contador = 0;

	public ExemploCustomItem(String title) { super(title); }
	  	// Métodos abstratos de CustomItem

	  public int getMinContentWidth() { return 200; }

	  public int getMinContentHeight() { return 50; }
	  ...
	  public void paint(Graphics g, int w, int h){
		g.drawString("Contador igual a "+contador,10,0,0);  
	  }
